...
async function getToken(){
  ...
  // Current TripServices authentication uses OAuth 2.0 client credentials.
  // Trial accounts still provide username/password, but the token request uses
  // the client_id/client_secret pair.
